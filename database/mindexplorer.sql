...
(
    ...
    '20/10/2003',
    '(21) 99213-5211',
    'programadora, estudante de computação e psicologia'
),
(
...
(
    ...
    '2003-10-20',
    '/usuários_img/1.jpeg',
    'Programadora, estudande de Computação, psicologia e do conhecimento humano.',
    SHA1('Qw3rtyui0P'),
    'admin'
),
(
...
(
    ...
    '2003-10-20',
    '/usuários_img/1.jpeg',
    'Programadora, estudante de Computação, psicologia e do conhecimento humano.',
    SHA1('Qw3rtyui0P'),
    'user'
),
(
